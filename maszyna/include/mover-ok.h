...
public:
  ...
  //bool __fastcall Attach(int ConnectNo, int ConnectToNr, PMoverParameters ConnectTo, int CouplingType);
	...
	bool __fastcall DirectionBackward();
	...
	double __fastcall ComputeMovement(double dt, double dt1, const TTrackShape &Shape, TTrackParam &Track, TTractionParam &ElectricTraction, const TLocation &NewLoc, TRotation &NewRot);
	double __fastcall FastComputeMovement(double dt, const TTrackShape &Shape, TTrackParam &Track, const TLocation &NewLoc, TRotation &NewRot);
